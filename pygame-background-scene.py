...
def main():
    ...
    while running:
        ...
        # Draw a blue line with thickness of 5 pixels
        # draw_line(screen, config.BLUE, [100, 100], [700, 500], 5)

        # # Draw a red line with thickness of 2 pixels
        ...
        # Draw text
        draw_text(screen, 'Henry was here!',text_font3, config.RED, 200, 450, bold=True, italic=True)
